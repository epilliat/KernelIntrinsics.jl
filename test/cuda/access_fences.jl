@kernel function example_kernel(data::CuDeviceArray)
    # Default access
    @access data[1] = 10
...
buf = IOBuffer()
@device_code_ptx io = buf example_kernel(CUDABackend(), 256)(data; ndrange=256)
...
CUDA.@sync example_kernel(CUDABackend(), 256)(data; ndrange=256)
